...
def GAS(pi,qk,ski,I,N,max_iter):
    ...
    for i in range(max_iter):
        ...
        g = lambda x: G_find_zeros_2(x,r_matrix,phi_matrix,ski,lambda_matrix,z_matrix,psi_matrix,qk,I) # funcion g(zeta)
...
def negativo(matriz,str=""):
    hay_negativo = np.any(matriz < 0)
...
def plot_mutual_information_plane_gas(pi,qk,ski,N):
    ...
    for I in np.linspace(epsilon,0.2,10):
        gas_result=GAS(pi,qk,ski,I,N,max_iter=100)
